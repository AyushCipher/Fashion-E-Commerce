                ...
                <form action="" onSubmit={handleLogin} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
                    ...
                    <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                        ...
                        <div className='w-[100%] relative'>
                            ...
                            {!show && <IoEyeOutline className='w-[20px] h-[20px] cursor-pointer absolute right-[5%] top-[15px]' onClick={() => setShow(prev => !prev)} />}
                            {show && <IoEye className='w-[20px] h-[20px] cursor-pointer absolute right-[5%] top-[15px]' onClick={() => setShow(prev => !prev)} />}
                        </div>

                        {/* Forgot Password Link */}
                        <p className='text-[14px] text-[#7ab7ff] cursor-pointer hover:underline self-end' onClick={() => navigate("/forgotpassword")}>
                            Forgot Password?
                        </p>
                        ...
                        <p className='flex gap-[10px]'>Don't have an account? <span className='text-[#5555f6cf] text-[17px] font-semibold cursor-pointer' onClick={() => navigate("/signup")}>Create New Account</span></p>
                    </div>
                </form>
            </div>
        </div>
